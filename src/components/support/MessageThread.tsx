...
export function MessageThread({ messages, currentUserType, onSendMessage, isLoading }: MessageThreadProps) {
    ...
    return (
        <Card className="h-[600px] flex flex-col border shadow-sm">
            ...
            <ScrollArea className="flex-1 p-4" ref={scrollRef}> // Note: 'ref' on ScrollArea might need viewport ref directly if Radix
                {/* Fallback to simple div with overflow if scrollarea ref issues occur in this specific implementation, but trying standard way first */}
