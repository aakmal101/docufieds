                    ...
                    {loading ? (
                        ...
                        <div className="rounded-md border">
                            <Table>
                                ...
                                <TableBody>
                                    {apps.map((app) => (
                                        <TableRow key={app.id} className="cursor-pointer hover:bg-gray-50" onClick={() => router.push(`/admin/support-lead/applications/${app.id}`)}>
                                            ...
                                            <TableCell>
                                                {app.assignment?.[0]?.member?.user?.fullName || <span className="text-gray-400 italic">Unassigned</span>}
                                            </TableCell>
                                            <TableCell>
